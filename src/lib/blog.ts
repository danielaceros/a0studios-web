...
export const blogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios trabajo con tres modalidades sencillas: Solo Grabación, Grabación + Edición y Producción Completa. Te respondo hoy, sin compromiso.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Por eso en A0Studios encaja bien un formato de ático-estudio: se siente real, respira mejor en cámara y da una imagen más editorial. Profesional, sí, pero sin ese olor a plató genérico que mata naturalidad.",
      },
      ...
      {
        type: "faq",
        question: "¿A0Studios sirve solo para podcast o también para reels y entrevistas?",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si llevas invitado, coméntale de antemano cómo va a ir la sesión: duración, qué ropa es mejor para cámara (evitar rayas finas, estampados pequeños o colores muy saturados), si hay que traer algo preparado. Si vas solo, comparte el listado de piezas con el equipo del estudio antes para que puedan preparar el set según tu estética. En A0Studios hacemos una llamada breve de planificación previa a cada sesión para llegar con el plan cerrado y no perder tiempo en ajustes básicos.",
      },
      ...
      {
        type: "faq",
        question: "¿A0Studios tiene teleprompter?",
  ...
  },
  {
    ...
    body: [
      ...
      { type: "heading", level: 2, text: "Preguntas frecuentes" },
      {
        ...
        answer: "No si el estudio está preparado. En A0Studios trabajamos con difusores, estores y luces de apoyo que permiten mantener una imagen consistente aunque cambie la hora o haya nubes. La luz natural es un recurso, no un inconveniente.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si quieres ver el espacio en persona o empezar a planificar una sesión, escríbenos desde /#contacto. En A0Studios trabajamos con marcas que saben que el entorno visual del contenido no es un detalle menor: es parte del mensaje.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios lo vemos en cada sesión: hay perfiles que llegan con el iPhone y un guión claro y sacan piezas que funcionan perfectamente bien. Y otros que traen equipo caro y salen con material que no sirve porque el espacio estaba mal planteado, la luz no acompañaba o el audio tiene demasiado ruido ambiente. El equipo importa, sí, pero no es lo primero. Lo primero es el contexto en el que grabas.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "El espacio condiciona todo lo demás. Un fondo con profundidad, texturas reales o entorno urbano da contexto visual sin que tengas que añadir recursos de edición. Un fondo plano o con desorden visible es un problema que no se puede corregir en postproducción sin que se note. Por eso en A0Studios el ático tiene distintas opciones de fondo según el tipo de reel: fondo neutro, zona con luz natural, vista de Madrid o setup interior más editorial. No tienes que adaptar tu contenido al espacio: el espacio se adapta a lo que necesitas.",
      },
      ...
      },
      {
        ...
        answer: "No. Basta con 3-5 puntos clave por pieza. Los reels más naturales suelen ser los que tienen estructura pero no están leídos palabra por palabra. Si prefieres teleprompter, en A0Studios lo tenemos disponible: mándanos el texto antes de la sesión y lo tenemos configurado desde el primer minuto.",
      },
      {
        type: "faq",
        question: "¿A0Studios tiene equipo de grabación incluido o tengo que traer el mío?",
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "Depende del formato. Para entrevistas, un guión de preguntas bien preparado es suficiente. Para formatos de solo voz o exposición directa, un esquema o teleprompter ayuda a mantener el ritmo y reducir el tiempo de edición. En A0Studios tenemos teleprompter disponible.",
      },
      {
        type: "paragraph",
        text: "Si estás pensando en añadir vídeo a tu podcast o quieres grabar el próximo episodio con un resultado profesional desde el primer frame, en A0Studios podemos organizarlo. Escríbenos desde /#contacto y te cuento cómo funciona una sesión.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "El batch recording —grabar todo el contenido de semanas en un solo bloque— cambia la ecuación. No requiere más presupuesto ni un equipo mayor. Requiere un cambio de mentalidad y un plan claro antes de llegar al estudio. En A0Studios lo vemos funcionar en casi todas las sesiones: quien llega con lista de piezas sale con material para semanas. Quien improvisa, graba uno o dos clips y pierde el día.",
      },
      ...
      { type: "heading", level: 3, text: "El flujo en A0Studios: de lista a clips entregados" },
      {
        type: "paragraph",
        text: "En una sesión de batch recording en A0Studios el flujo habitual es: 15 minutos de setup y repaso de la lista con el equipo, bloque de grabación por formato con tomas organizadas, revisión rápida del material bruto al cerrar la sesión para confirmar que está todo. Con Grabación + Edición, recibes los clips editados en 24-48 horas. Con Producción Completa, incluimos también la estrategia de distribución: qué publicar, cuándo y en qué canal para sacar el máximo de cada pieza.",
      },
      ...
      },
      {
        ...
        answer: "Sí, y es más fácil de lo que parece si llegas preparado. El mayor salto lo dan quienes ya han grabado alguna sesión sin plan y entienden lo que cuesta improvisar. En A0Studios hacemos una llamada de preparación previa con todos los clientes para llegar con el plan cerrado y sin sorpresas.",
      },
      {
        type: "faq",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios hemos grabado con founders que llegaron después de meses intentándolo en su despacho y con otros que vinieron directamente desde el primer clip. El patrón que se repite en los primeros es siempre el mismo: el espacio les limitaba, aunque no sabían bien cómo explicarlo. Te cuento cuáles son esas diferencias y cuándo importan de verdad.",
      },
      ...
      {
        type: "faq",
        question: "¿Puedo visitar A0Studios antes de reservar para ver si el espacio encaja?",
      ...
      {
        type: "paragraph",
        text: "Si estás en el punto en que la oficina ya no da más de sí pero no tienes claro si el salto a estudio tiene sentido para tu caso, escríbenos desde /#contacto. En A0Studios lo miramos juntos y te contamos, sin compromiso, qué opciones encajan mejor con el tipo de contenido que quieres producir.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      { type: "heading", level: 2, text: "Preguntas frecuentes" },
      {
        ...
        answer: "Con buena preparación previa, entre 12 y 18 clips de 60-90 segundos. El flujo habitual en un content day en A0Studios es: listado de piezas cerrado antes de llegar, grabación en bloque por formato y revisión del material antes de desmontar el set.",
      },
      {
        type: "faq",
      ...
      {
        type: "faq",
        question: "¿En A0Studios podéis hacer el content day para LinkedIn de principio a fin?",
      ...
      {
        type: "paragraph",
        text: "Si quieres empezar a construir autoridad en LinkedIn con un flujo de producción que no consuma toda tu semana, escríbenos desde /#contacto. En A0Studios podemos organizar un content day adaptado a tu tipo de contenido y al posicionamiento que quieres construir.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "Una cámara que grabe en 1080p o 4K, audio externo —micrófono de condensador o solapa— y una iluminación que no genere sombras duras. En A0Studios tenemos todo el equipo disponible, incluido teleprompter si prefieres leer el guión en lugar de memorizar.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si quieres grabar tu VSL para LinkedIn con un setup que respalde el mensaje desde el primer frame, en A0Studios podemos organizarlo. Escríbenos desde /#contacto y cuéntanos el objetivo de la pieza: te respondemos el mismo día.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "En una jornada de 4-5 horas con material bien preparado, es habitual sacar entre 15 y 25 piezas cortas. Si incluyes formatos más largos —episodios completos de podcast, VSLs— el número baja. En A0Studios recomendamos no superar los 20-22 clips en un solo día para mantener la calidad de la última toma tan alta como la primera.",
      },
      {
        type: "faq",
        question: "¿Necesito guiones escritos o sirve con un esquema?",
        answer: "Para piezas de 30-60 segundos, un esquema con los puntos clave suele dar más naturalidad que leer un guión cerrado. Para formatos más largos o con estructura específica —VSL, episodio formativo—, conviene un guión más desarrollado. El teleprompter en A0Studios está disponible para quien prefiere leer sin perder el contacto visual con la cámara.",
      },
      {
        type: "faq",
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "Para los formatos tipo take o explicativo, un esquema de 3-5 puntos clave por pieza da más naturalidad que memorizar. Si prefiere teleprompter, en A0Studios lo tenemos disponible: basta con mandar el texto antes de la sesión para tenerlo configurado desde el primer minuto.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si quieres organizar una sesión de reels para tu empresa o empezar a grabar como CEO con un formato que funcione, escríbenos desde /#contacto. En A0Studios lo planificamos contigo antes de la sesión para que entres sabiendo qué grabar y salgas con material para semanas.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios hemos grabado podcasts y entrevistas con setup multicámara para marcas, founders y equipos de marketing. Lo que sigue es lo que aprendes cuando comparas los resultados de uno y otro formato.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Un setup funcional para podcast con 2 personas necesita como mínimo 3 posiciones: plano general con ambos presentadores, plano medio del host y plano medio del invitado. Si añades una cuarta cámara de detalle —manos, micro, pantalla— el material de b-roll se multiplica sin esfuerzo extra en grabación. En A0Studios trabajamos habitualmente con 2 Sony A7 y 1 cámara fija para el plano general. No hace falta más para que el montaje tenga variedad real.",
      },
      {
        type: "heading",
        level: 3,
      ...
      },
      {
        ...
        answer: "El setup físico suma entre 20 y 40 minutos dependiendo de cuántas cámaras y si hay que ajustar iluminación por posición. La grabación en sí dura exactamente lo mismo. Lo que cambia es la postproducción, que es más larga. En A0Studios el setup está listo antes de que llegues, así que no resta tiempo de tu sesión.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si quieres montar un podcast con vídeo en Madrid o convertir un episodio en contenido para redes, escríbenos desde /#contacto. En A0Studios diseñamos el setup según el formato y el volumen de material que necesitas.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "Cómo usar el teleprompter sin parecer robot: técnica, ritmo y ajustes para grabar con naturalidad en estudio. Guía práctica de A0Studios Madrid.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
      ...
      },
      {
        ...
        answer: "Depende del punto de partida. Una persona con experiencia en presentaciones o locución lo controla en 20-30 minutos de práctica. Alguien sin hábito de cámara puede necesitar 2-3 sesiones para que el resultado sea convincente. En A0Studios, si es tu primera vez con el prompter, lo dejamos rodando sin presión durante los primeros 10 minutos para que cojas el ritmo antes de grabar la pieza definitiva.",
      },
      {
        type: "faq",
      ...
      {
        type: "faq",
        question: "¿Qué aplicación de teleprompter usáis en A0Studios?",
      ...
      },
      {
        ...
        answer: "Sí, aunque hay que ajustar la posición del reflector para evitar destellos. Las monturas metálicas son las que más reflejan. Un ajuste de ángulo de 2-3 grados en el cristal suele resolver el problema. En A0Studios lo testeamos antes de empezar si la sesión lo requiere.",
      },
      {
        type: "paragraph",
        text: "Si tienes un mensaje que necesita precisión y quieres grabarlo con naturalidad, escríbenos desde /#contacto. En A0Studios tenemos el equipo y el proceso para que el teleprompter deje de darte miedo y empiece a trabajar para ti.",
      },
    ],
  },
  {
    ...
    description:
      "Tipos de luz, setup básico de tres puntos y errores que arruinan el vídeo antes de empezar a hablar. Los fundamentos de iluminación que usamos en A0Studios.",
    ...
    intent: "informacional",
    excerpt:
      "La iluminación decide si el vídeo parece profesional o no. Estos son los básicos que usamos en A0Studios y que puedes aplicar desde el primer día.",
    seoTitle: "Iluminación para grabación de contenido",
    metaDescription:
      "Iluminación para grabación de contenido: tipos de luz, setup básico y errores que arruinan el vídeo antes de que empieces a hablar. Guía de A0Studios Madrid.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
      ...
      },
      {
        ...
        answer: "Sí, si el espacio está preparado para controlarla. La luz natural es la fuente más suave y natural que existe, pero cambia con las nubes, la hora y la orientación de las ventanas. En A0Studios trabajamos con difusores y estores que permiten mantener una imagen consistente aunque cambie la luz exterior. Sin control, la luz natural puede convertirse en un problema.",
      },
      {
        type: "faq",
        question: "¿Qué temperatura de color es mejor para grabar contenido de marca?",
        answer: "Entre 5000 K y 5500 K, que es la temperatura que más se aproxima a la luz de día natural. Esa gama da una piel con tono neutro y un blanco limpio sin la frialdad del blanco puro ni la calidez excesiva de los 3200 K. En A0Studios ajustamos la temperatura de color según el entorno de cada sesión para mantener coherencia entre los planos.",
      },
      {
        type: "faq",
        question: "¿Cuánto tiempo lleva montar un setup de iluminación básico?",
        answer: "Un setup de tres puntos de luz —key, fill y fondo— bien organizado se monta en 20-30 minutos en un espacio nuevo. En A0Studios el setup está listo antes de que llegues. Si traes tu propio equipo, recomendamos un ensayo previo en el mismo espacio para no perder tiempo de sesión en ajustes básicos.",
      },
      {
        type: "paragraph",
        text: "Si quieres grabar tu próxima sesión de contenido con una iluminación resuelta desde el primer minuto, en A0Studios lo tenemos preparado. Escríbenos desde /#contacto y te contamos cómo funciona una sesión.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "Elegir el micrófono correcto marca la diferencia entre un audio tolerable y uno que retiene al oyente. Esto es lo que usamos en A0Studios y por qué.",
    seoTitle: "Micrófonos para Podcast y Entrevistas",
    metaDescription:
      "Micrófonos para podcast y entrevistas: tipos, diferencias y cuándo usar cada uno. Guía práctica desde el estudio A0Studios Madrid.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "En A0Studios usamos distintos tipos de micrófonos según lo que graba cada cliente. No hay un micrófono que sea el mejor para todo. Hay uno que encaja con lo que tú haces. Esto es lo que necesitas saber para elegir bien.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Si tienes dudas sobre qué micrófono usar en tu próxima sesión de podcast o entrevista en Madrid, en A0Studios lo resolvemos antes de que llegues. Escríbenos desde /#contacto y te contamos qué setup montamos según lo que necesitas grabar.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "Espacio, equipo y flujo de trabajo para grabar cursos online con calidad profesional en Madrid. Lo que funciona en A0Studios para formadores y empresas.",
    ...
    body: [
      ...
      {
        type: "faq",
        question: "¿Cuántos módulos se pueden grabar en una jornada en A0Studios?",
      ...
      },
      {
        ...
        answer: "Sí, aunque sea un corte básico. Los alumnos toleran mal los silencios largos, las tomas fallidas o los arranques vacilantes. Un montaje limpio —cortar errores, ajustar audio, añadir títulos de módulo— mejora la percepción del curso aunque el contenido sea el mismo. Con el servicio de Grabación + Edición en A0Studios, entregamos el vídeo editado y listo para subir.",
      },
      {
        type: "faq",
        question: "¿Es necesario grabar con croma o fondo verde?",
        answer: "No. El croma funciona bien en producción grande con equipo dedicado, pero en sesiones de un día genera complicaciones: espacio extra, iluminación específica y edición posterior más laboriosa. Un fondo real con carácter —ladrillo visto, librería, madera— transmite más personalidad y cuesta menos en producción. En A0Studios el fondo del ático aporta ese contexto sin efectos.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si estás pensando en grabar un curso online en Madrid y no sabes por dónde empezar, en A0Studios te ayudamos a estructurar la jornada antes de que llegues. Escríbenos desde /#contacto y te decimos qué necesitas según el tipo de formación que quieres producir.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Grabar en horizontal y recortar en vertical para Shorts es el atajo que peor funciona. Pierdes un 40% de la imagen y el encuadre queda forzado. Si planeas publicar en Shorts, graba en 9:16 desde el principio, bien con la cámara principal en posición vertical o con una segunda cámara dedicada. En A0Studios, cuando los content days incluyen Shorts, montamos un ángulo vertical específico que no interfiere con el setup horizontal del resto de la sesión. Un trípode con un smartphone reciente —iPhone 15, Samsung S24— bien configurado es suficiente para la mayoría de casos.",
      },
      ...
      {
        type: "paragraph",
        text: "Si quieres incluir YouTube Shorts en tu próximo content day en Madrid, en A0Studios lo planificamos contigo antes de llegar. Escríbenos desde /#contacto y te decimos qué tiene sentido según el tipo de contenido que produces.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios llevamos tiempo haciendo jornadas de este tipo con founders, equipos de marketing y marcas personales. Lo que hemos aprendido es simple: el orden importa tanto como el volumen. Si llegas sin un esquema de qué vas a grabar y en qué secuencia, pierdes las mejores horas del día en decisiones que debían estar tomadas antes de entrar en sala.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Una jornada de 6-8 horas en estudio elimina ese coste fijo. Lo pagas una vez y grabas 3-4 semanas de material. El ratio esfuerzo/output cambia completamente. En A0Studios, la mayoría de los clientes que vienen una vez al mes sacan entre 15 y 30 piezas terminadas por sesión: vídeos largos para YouTube, clips cortos para LinkedIn o Instagram, pilares de podcast y en algunos casos testimonios o piezas de producto.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Los testimonios, entrevistas o piezas donde solo hablas de un producto o servicio concreto van bien al final. No requieren el mismo nivel de energía narrativa que un tutorial, y si el invitado llega a media mañana, el timing encaja perfectamente. En A0Studios usamos multicámara para este tipo de grabaciones: Sony A7 como cámara principal y una segunda cámara en plano más cerrado para los cortes de edición.",
      },
      {
        type: "image",
      ...
      { type: "heading", level: 2, text: "Preguntas frecuentes" },
      {
        ...
        answer: "Depende del formato y la complejidad. Una jornada bien planificada en A0Studios suele producir entre 2 y 4 vídeos largos de 10-20 minutos más 8-15 clips cortos. Si el foco son solo clips cortos de 60-90 segundos, el número puede superar los 20.",
      },
      {
        type: "faq",
      ...
      },
      {
        ...
        answer: "Para vídeos de más de 5 minutos, siempre es mejor guión o al menos bullets detallados. En A0Studios usamos teleprompter para quienes prefieren leer sin que se note, pero incluso con notas en mano el resultado mejora frente a improvisar desde cero.",
      },
      {
        type: "faq",
        question: "¿Qué equipo usa A0Studios en una jornada intensiva multicámara?",
      ...
      {
        type: "paragraph",
        text: "Si estás pensando en organizar tu primera jornada intensiva de contenido o quieres mejorar cómo estructuras las que ya haces, en A0Studios planificamos la sesión contigo antes del día de grabación. El tiempo en estudio es más productivo cuando lo que vas a grabar ya está decidido. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "Sí. En A0Studios hemos grabado episodios de debate con tres participantes. La clave es que cada uno tenga micro propio y que todos conozcan las reglas básicas: hablar uno a uno, no interrumpir y mantener la posición respecto al micrófono.",
      },
      {
        type: "paragraph",
        text: "Preparar bien a un invitado no requiere mucho tiempo, pero sí requiere hacerlo con intención. Si estás planificando un episodio con alguien externo y quieres que el resultado sea aprovechable para clips, newsletters y contenido de redes, en A0Studios podemos ayudarte a estructurar la sesión antes del día de grabación. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios trabajamos los dos. El primero para quien necesita velocidad y volumen. El segundo para quien quiere que cada pieza sea un activo real. La diferencia no está en el programa que usas ni en el editor que contratas. Está en el criterio con el que se toman las decisiones de montaje.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "El montaje empieza en el guión o en la sala, no en DaVinci Resolve o Premiere. Antes de tocar un clip hay que decidir qué va primero, dónde está el gancho y cuándo llega la resolución. Un editor sin ese mapa edita bien técnicamente pero sin dirección. En A0Studios el proceso siempre pasa por revisar la estructura del material antes de montar.",
      },
      ...
      },
      {
        ...
        answer: "Sí, y tiene sentido si estás validando formatos. Cuando sepas qué tipo de contenido funciona para tu audiencia, ya inviertes en el criterio editorial. Muchos de nuestros clientes en A0Studios hacen exactamente ese recorrido.",
      },
      {
        type: "paragraph",
        text: "Si tienes brutos de sesiones anteriores y no estás seguro de si la edición está funcionando, lo primero es revisar el criterio editorial. En A0Studios trabajamos tanto la grabación como la postproducción. Cuéntanos qué tienes y qué quieres conseguir desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Grabación + Edición te da el vídeo terminado. Grabamos y montamos: cortes, música, títulos, subtítulos si los necesitas. Es el servicio más habitual en A0Studios porque cubre el 80% de los casos: podcast, entrevistas, reels para empresa, clips de LinkedIn.",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer: "Con una planificación previa adecuada, una sesión de 3-4 horas en A0Studios genera habitualmente entre 4 y 8 semanas de contenido distribuible. El volumen depende del tipo de formato: un podcast con clips tiene mayor rendimiento por hora grabada que una VSL de producto que requiere más precisión.",
      },
      {
        type: "faq",
  ...
  },
  {
    ...
    description:
      "Cómo grabar testimonios de clientes y casos de éxito que generen confianza. Guía práctica sobre preparación, técnica y preguntas desde el estudio A0Studios en Madrid.",
    ...
    metaDescription:
      "Cómo grabar testimonios de clientes y casos de éxito que generen confianza. Guía práctica desde el estudio A0Studios en Madrid centro.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "En A0Studios hemos grabado testimonios y piezas de casos de éxito para equipos de marketing, agencias y empresas que necesitan ese tipo de contenido para cerrar ventas, justificar inversiones o reforzar la credibilidad en licitaciones. Lo que marca la diferencia no es el presupuesto: es el proceso.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "No se trata de darle un guión. Se trata de tener una conversación de 10-15 minutos antes de encender la cámara para que llegue sabiendo qué se le va a preguntar y por qué. Nadie habla bien cuando está sorprendido. En A0Studios preparamos al entrevistado con una lista de 4-5 preguntas abiertas que compartimos con antelación, no para que ensaye respuestas, sino para que llegue pensado. La diferencia en el lenguaje corporal es inmediata.",
      },
      {
        type: "heading",
        level: 3,
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios hemos visto cómo los clientes que planifican la sesión con los clips en mente salen con 15 o 20 piezas listas para publicar directamente. Y los que no lo planifican, salen con una grabación de 90 minutos que luego no saben cómo cortar. La diferencia es de estructura, no de suerte.",
      },
      {
        type: "image",
      ...
      },
      {
        ...
        answer:
          "No necesariamente. En A0Studios grabamos en horizontal con cámaras bien encuadradas y reencuadramos en edición para vertical. Si el encuadre original deja espacio arriba y abajo, el reencuadre queda bien sin perder información importante.",
      },
      {
        type: "faq",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "El micrófono dinámico — Shure SM7B, Rode PodMic — es el estándar para podcast y entrevistas largas en interior. Rechaza bien el ruido ambiental, no necesita un tratamiento acústico perfecto y aguanta bien las variaciones de nivel de voz entre personas distintas. En A0Studios lo usamos para sesiones con 2 o más personas a mesa, formatos de más de 20 minutos y espacios que no son completamente silenciosos. Su punto débil: necesita buena preamp. Sin un previo decente, el dinámico no da su mejor versión y el ruido de fondo relativo sube.",
      },
      { type: "heading", level: 3, text: "Condensador — narraciones y presentaciones a cámara" },
      {
        type: "paragraph",
        text: "El micrófono condensador — Rode NT1, AKG C214 — capta con más detalle y amplitud que el dinámico. Ideal para narraciones en off, cursos online grabados a cámara fija o piezas donde quieres presencia y cuerpo de voz sin coloración agresiva. El problema es que necesita tratamiento acústico: en un espacio con paredes duras y sin absorción, el condensador amplifica el problema en lugar de la voz. En A0Studios el ático tiene absorción suficiente para que el condensador suene bien sin preparación adicional del espacio.",
      },
      ...
      },
      {
        ...
        answer:
          "En A0Studios usamos habitualmente un shotgun en boom para mantener el encuadre limpio sin cables visibles. Si el presentador habla directo a cámara sin moverse, el shotgun bien posicionado da un resultado limpio y no requiere postproducción de audio intensiva.",
      },
      {
        type: "faq",
      ...
      },
      {
        ...
        answer:
          "Mucho, y no solo por el equipo — por el espacio. Un ático con absorción correcta elimina el eco que arruina el audio doméstico. En A0Studios, con un dinámico o condensador bien ganado, el audio sale listo para mezcla sin tratamiento pesado en postproducción.",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos vídeo corporativo para webs de empresas, agencias y equipos de marketing que necesitan algo más sólido que un móvil en la oficina, pero sin caer en el vídeo institucional de plató que nadie termina de ver entero. La clave está en tratar la sesión como un guion de página, no como una grabación suelta.",
      },
      {
        type: "image",
  ...
  },
  {
    ...
    body: [
      {
        type: "paragraph",
        text: "Cuando una marca decide grabar un spot publicitario, la primera duda casi nunca es de presupuesto. Es de formato: ¿esto se graba en estudio, en localización o mezclando ambos? Un estudio de grabación como A0Studios resuelve buena parte de esa pregunta antes de que se convierta en un problema el día del rodaje: control total de luz, de sonido y de fondo, sin depender del clima ni del ruido de una calle de Madrid.",
      },
      {
        type: "paragraph",
        text: "En A0Studios grabamos spots para marcas, agencias y empresas que necesitan algo con acabado publicitario real, no un vídeo de producto grabado con el móvil de la oficina. La diferencia no está solo en la cámara. Está en cómo se planifica la sesión antes de encender nada.",
      },
      {
        type: "image",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos cada semana marcas personales, empresas y equipos de marketing que llegan con guion cerrado, buena luz prevista y cero decisión tomada sobre qué va a aparecer detrás. Y el fondo cambia más de lo que parece: puede reforzar el mensaje o competir con él.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Lo mismo pasa con el color. Un fondo con los colores de marca ayuda al reconocimiento visual en redes, pero si se satura demasiado, compite con la persona que habla. La regla que seguimos en A0Studios es simple: el fondo puede sugerir la marca, nunca debe gritarla.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Por eso en A0Studios priorizamos equipo que resuelve bien esos cuatro puntos antes que equipo que solo suma megapíxeles. Una cámara media bien configurada, con buen audio y buena luz, da mejor resultado que una cámara de gama alta mal usada.",
      },
      { type: "heading", level: 2, text: "Cómo se hace bien" },
      ...
      {
        type: "faq",
        question: "¿Qué cámara usáis en A0Studios?",
        answer:
      ...
      {
        type: "faq",
        question: "¿Puedo traer mi propia cámara a la sesión en A0Studios?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "faq",
        question: "¿Trabajáis eventos fuera del ático de A0Studios?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "El problema es que grabar 'como si fuera casero' en casa, con luz de ventana y el móvil apoyado en una torre de libros, casi nunca sale bien a la primera. En A0Studios grabamos UGC en estudio: mantenemos ese tono cercano pero controlamos luz, audio y encuadre para que el resultado se pueda usar de verdad.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Si tu marca necesita contenido UGC con esa mezcla de auténtico y bien grabado, en A0Studios montamos la sesión completa: guion de apoyo, grabación y clips listos para publicar. Escríbenos desde /#contacto y lo hablamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tu empresa quiere grabar contenido de employer branding para atraer talento, en A0Studios montamos la sesión completa: preguntas de apoyo, grabación de varias personas del equipo y clips listos para publicar. Escríbenos desde /#contacto y lo hablamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tienes un webinar o una masterclass en el calendario y quieres que se vea y se escuche a nivel profesional, en A0Studios montamos cámara, pantalla y audio para que salga bien a la primera. Escríbenos desde /#contacto y lo preparamos.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "paragraph",
        text: "Cada vez llegan más marcas a A0Studios con el mismo encargo: necesitan un vídeo de su producto para la ficha de ecommerce, para un anuncio o para la web, y lo que tienen grabado hasta ahora es con el móvil, encima de la mesa de la oficina, con la luz que entra por la ventana esa tarde. Se nota. Y cuando el producto es lo que tiene que convencer a alguien de comprar, ese detalle pesa.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si tienes un producto que necesita verse bien de verdad, en A0Studios montamos fondo, luz y cámara para que el vídeo cumpla su función: que quien lo vea entienda exactamente qué está comprando. Escríbenos desde /#contacto y lo preparamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Un micrófono cardioide colocado cerca de la boca (10-15 cm) capta mucha más señal directa que sala, así que el eco residual pesa menos en la mezcla final. Colocado lejos, en cambio, el micrófono capta más habitación que voz, por muy bien tratada que esté la sala. Por eso en A0Studios ajustamos la distancia antes de grabar, no la posición de la persona respecto a la cámara.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si grabas podcast, entrevistas o vídeo con audio en directo, el sonido de la sala pesa tanto como la imagen, aunque se note menos a simple vista. En A0Studios la sala ya está tratada para esto, así que no tienes que pensarlo tú. Escríbenos desde /#contacto y lo hablamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "faq",
        question: "¿Qué colores evitan mejor en el estudio de A0Studios?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos bastantes vídeos de este tipo: founders que necesitan una pieza para un demo day, una ronda seed o simplemente para tener algo que mandar por email sin depender de agendar una llamada. La producción no arregla una idea floja, pero sí puede hundir una buena si se ve amateur, y eso es lo que más nos piden evitar.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Si estás preparando una ronda y necesitas un vídeo pitch que esté a la altura de lo que has construido, en A0Studios lo grabamos en una sesión de mañana o tarde, con el guion trabajado antes de pisar el estudio y sin alargar el proceso más de la cuenta. Escríbenos desde /#contacto y lo planeamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si estás pensando en dar de alta un proceso de onboarding en vídeo para tu empresa, en A0Studios lo planteamos en bloques modulares desde el primer día de grabación, para que actualizarlo más adelante no suponga rehacer nada. Escríbenos desde /#contacto y lo vemos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tienes un producto que explicar y quieres que el vídeo resuelva dudas en vez de sonar a anuncio, en A0Studios grabamos la parte de cara y montamos la de pantalla en el mismo flujo de edición. Escríbenos desde /#contacto y lo planteamos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Esto es justo lo que en A0Studios llamamos vídeo con estética nativa: se graba en el mismo ático, con la misma cámara y la misma luz que un reel cualquiera, pero el guion está pensado para pauta desde el primer segundo, no adaptado después con un corte de audio.",
      },
      { type: "heading", level: 2, text: "Cómo se hace bien" },
      ...
      {
        type: "paragraph",
        text: "Si tienes una campaña en marcha y necesitas variantes de vídeo que aguanten la pauta sin fatigarse en una semana, en A0Studios grabamos varias versiones en la misma sesión pensadas desde el guion para Meta y TikTok. Escríbenos desde /#contacto y lo planteamos.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "paragraph",
        text: "Casi todos los founders y equipos de marketing que llegan a A0Studios hacen la misma pregunta en algún momento, aunque no siempre en voz alta: ¿esto está compensando? Han grabado unas cuantas sesiones, tienen contenido publicado, y aun así no saben si el dinero y el tiempo invertidos están generando algo o si simplemente están alimentando un feed que se ve bien pero no mueve nada.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si estás decidiendo cuánto invertir en contenido este trimestre y quieres montar algo que sí puedas medir desde el primer mes, en A0Studios te ayudamos a definir qué grabar y cómo hacer seguimiento del resultado. Escríbenos desde /#contacto y lo hablamos.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "El b-roll es lo que separa un vídeo plano de uno que engancha. Qué es, cuándo grabarlo y cómo lo integramos en cada sesión de A0Studios.",
    seoTitle: "Qué es el B-roll y por qué lo necesitas",
    metaDescription:
      "El b-roll es el material de apoyo que hace que tu vídeo de marca se vea profesional. Qué es, cuándo grabarlo y cómo lo usamos en A0Studios.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si vas a grabar contenido de marca y quieres que el resultado se note producido, no improvisado, en A0Studios planificamos el b-roll como parte de la sesión, no como un añadido de última hora. Escríbenos desde /#contacto y lo montamos juntos.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos coberturas de eventos corporativos completas: ponencias enteras, entrevistas, streaming en directo. El aftermovie es otra cosa. No busca informar, busca transmitir energía. Coge los mejores segundos del día — la sala llenándose, el aplauso al ponente, la gente hablando entre pausas, el momento en que se apagan las luces para empezar — y los monta en una pieza corta pensada para redes.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si organizas un evento y quieres que quede algo más que fotos sueltas, en A0Studios planificamos el aftermovie como parte de la cobertura, no como un extra de última hora. Escríbenos desde /#contacto y lo preparamos juntos.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "Grabar un podcast con un invitado conectado por videollamada no tiene que sonar peor que uno grabado en persona. Así lo montamos en A0Studios para que no se note la diferencia.",
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos episodios con invitado presencial casi cada semana, pero cada vez llegan más peticiones para combinar a alguien en el estudio con alguien conectado por videollamada. Funciona bien si se prepara con el flujo correcto de audio y vídeo. Si se improvisa, se nota enseguida: eco, cortes, un invitado que suena a llamada de teléfono al lado de otro con calidad de estudio.",
      },
      {
        type: "image",
      ...
      },
      {
        ...
        answer:
          "Puede aparecer en vídeo sin problema. En A0Studios lo integramos en pantalla dentro del plano del estudio, como una entrevista con dos ubicaciones a la vez.",
      },
      {
        type: "faq",
      ...
      {
        type: "paragraph",
        text: "Si tienes un episodio con un invitado que no puede venir a Madrid, en A0Studios montamos la grabación híbrida para que suene como si estuviera en la sala. Escríbenos desde /#contacto y lo preparamos juntos.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "Un directo no da margen para repetir la toma. Así preparamos en A0Studios las cámaras, el audio y la conexión antes de salir en streaming.",
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tienes un evento o un lanzamiento que necesita salir en directo y no solo grabado, en A0Studios montamos el streaming con las cámaras, el audio y la conexión preparados para que aguante. Escríbenos desde /#contacto y lo planificamos juntos.",
      },
    ],
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "En redes la mayoría ve el vídeo con el sonido apagado. Sin subtítulos, ese vídeo no comunica nada. Así los preparamos en A0Studios para que no se note el trabajo detrás.",
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si grabas contenido en A0Studios, la edición incluye subtítulos revisados a mano, no solo el volcado automático. Si quieres que tu próximo vídeo se entienda también con el sonido apagado, escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Hay un punto intermedio que funciona muy bien y que en A0Studios usamos a menudo: grabar un explicativo apoyado en b-roll y gráficos, pero con la voz de alguien reconocible de la marca, no de un locutor genérico. Se mantiene la coherencia de marca sin necesitar horas de rodaje a cámara para cada actualización del vídeo.",
      },
      { type: "heading", level: 2, text: "Cómo se hace bien" },
      ...
      {
        type: "paragraph",
        text: "Si tu próximo vídeo necesita una voz en off que suene a estudio y no a nota de voz, en A0Studios grabamos con tratamiento acústico y dirección de guion incluida. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tu próxima pieza depende de que alguien sostenga la cámara con presencia real, en A0Studios grabamos con dirección de encuadre y de ritmo incluida, no solo con la cámara encendida. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tu próximo vídeo necesita un fondo que no existe en ningún estudio real, en A0Studios montamos croma con iluminación y recorte limpio incluidos en la sesión. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos piezas para founders, marcas y equipos de marketing que después reparten ese contenido en varias plataformas a la vez. El error más habitual no es la calidad de imagen ni el guion: es tratar todas las plataformas igual cuando cada una premia un ritmo distinto.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "Si necesitas sacar de una sola sesión piezas para varias plataformas sin perder naturalidad en ninguna, en A0Studios lo planificamos así desde el guion. Escríbenos desde /#contacto.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "paragraph",
        text: "Cada sesión que se retrasa en sala por falta de información cuesta dinero. En A0Studios vemos el mismo patrón casi cada semana: el cliente llega con una idea general de lo que quiere grabar, pero sin las respuestas concretas que necesitamos para montar el planning — cuántas piezas salen de la sesión, en qué formato, con qué tono. Eso se resuelve antes de encender las cámaras, no dentro de la sala.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "La mayoría de marcas y founders que llegan a A0Studios sin experiencia previa en grabación no tienen este documento preparado, y no pasa nada — para eso hacemos una llamada de unos 15 minutos antes de la sesión. Pero cuanto más resuelto llega el cliente, menos tiempo se pierde ajustando en directo decisiones que se podían haber tomado con calma una semana antes.",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "Comprar la canción no te da derecho a usarla. Qué es una licencia de sincronización, qué bibliotecas usamos en A0Studios y los errores que meten a más marcas en un aviso de copyright.",
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios elegimos música en casi cada sesión de edición, así que sabemos dónde se suele fallar. No hace falta entender de leyes de propiedad intelectual para hacerlo bien. Hace falta saber qué tipo de licencia necesitas según dónde vas a publicar el vídeo y quién eres cuando lo publicas.",
      },
      {
        type: "image",
      ...
      {
        type: "paragraph",
        text: "La forma más simple es una biblioteca de música con licencia, tipo Epidemic Sound, Artlist o Musicbed. Pagas una suscripción mensual o anual y, mientras esté activa, puedes usar cualquier pista del catálogo en tus vídeos sin negociar nada pista por pista. Es lo que usamos en la mayoría de sesiones de edición en A0Studios: rapidez y cobertura legal en el mismo paso.",
      },
      ...
      {
        type: "faq",
        question: "¿A0Studios elige la música de mis vídeos?",
        answer:
  ...
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "El espectador decide si se queda o se va antes de que termines la primera frase. Cómo planificamos y grabamos el hook en A0Studios para que ese primer segundo no se pierda.",
    seoTitle: "El hook en vídeo: primeros 3 segundos",
    metaDescription:
      "Cómo grabar el hook de un vídeo: los primeros segundos que deciden si el espectador se queda, y cómo planificarlos antes de grabar en A0Studios Madrid.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
        text: "En A0Studios grabamos varios vídeos por semana para marcas y creators, y hay un patrón que se repite en los que funcionan y no está en los que no: los primeros que enganchan lo hacen desde el primer segundo, no desde el minuto uno. El espectador no espera a que el vídeo \"arranque de verdad\". Decide quedarse o saltar casi de inmediato.",
      },
      {
        type: "paragraph",
      ...
      },
      {
        ...
        answer:
          "En A0Studios solemos grabar varias tomas del arranque por separado, sueltas de contexto, para tener margen de elegir la mejor en la sala de edición sin repetir toda la sesión.",
      },
      {
        type: "faq",
        question: "¿A0Studios ayuda a escribir el hook antes de grabar?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En DaVinci Resolve, que es lo que usamos en A0Studios para esta parte, ambos pasos van seguidos: primero se nivela el material bruto, después se aplica el look. Sin ese primer paso, el grading amplifica cualquier diferencia entre planos en lugar de disimularla.",
      },
      { type: "heading", level: 2, text: "Cómo se hace bien" },
      ...
      {
        type: "faq",
        question: "¿A0Studios incluye color grading en la edición?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Define de antemano cuántas rondas de cambios incluye el proyecto —en A0Studios solemos trabajar con dos— y comunícalo así a todo el equipo que va a dar feedback antes de que empiece la revisión. Sin ese límite claro, es fácil que el proceso se convierta en una revisión abierta que no termina nunca y que desgasta tanto al editor como al cliente.",
      },
      {
        type: "image",
      ...
      {
        type: "faq",
        question: "¿A0Studios incluye rondas de revisión en la edición?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        answer:
          "En A0Studios con Producción Completa se puede entregar en 24-48 horas si el objetivo es publicarlo mientras el evento todavía tiene eco en redes. Para plazos más ajustados, lo hablamos antes de grabar para organizar el flujo de edición en consecuencia.",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    intent: "informacional",
    excerpt:
      "La mayoría de las personas que grabamos en A0Studios no son actores ni presentadores. Cómo dirigirlas para que salgan naturales sin memorizar nada.",
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Si tienes que grabar a alguien que nunca ha estado delante de una cámara y quieres que salga natural, en A0Studios dirigimos la sesión pensando en eso desde el minuto uno. Escríbenos desde /#contacto y lo preparamos juntos antes del día de grabación.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "En A0Studios grabamos la mayoría de las sesiones en plató porque ahí controlamos luz, sonido y tiempo. Salir fuera añade valor visual, pero también variables que no dependen de nosotros. Antes de decidir, conviene entender qué se gana y qué se arriesga con cada opción.",
      },
      {
        type: "image",
      ...
      },
      {
        ...
        answer:
          "Si no hay plan B bajo techo, se reprograma. Por eso en A0Studios solemos combinar: parte de la sesión en plató y solo los planos que necesitan contexto real fuera.",
      },
      {
        type: "faq",
        question: "¿A0Studios graba fuera del estudio de Ronda de Atocha?",
        answer:
  ...
  },
  {
    ...
    description:
      "Por qué se traba la voz delante de una cámara, qué se puede preparar antes de grabar y cómo pierden el miedo founders y equipos que graban por primera vez en A0Studios.",
    ...
    intent: "informacional",
    excerpt:
      "Casi nadie llega a su primera grabación relajado. Qué pasa realmente delante de una cámara y qué hacemos en A0Studios para que la sesión no se note forzada.",
    ...
    body: [
      {
        type: "paragraph",
        text: "Casi todos los founders y equipos que vienen a grabar por primera vez a A0Studios dicen lo mismo antes de empezar: \"a ver cómo salgo, no se me da bien esto\". Es la reacción más normal que hay. Hablar delante de una cámara no es lo mismo que hablar delante de una persona, aunque el cerebro tarde un rato en entenderlo.",
      },
      {
        type: "paragraph",
        text: "El miedo a la cámara no se quita leyendo consejos la noche antes. Se reduce con preparación concreta y con unos primeros minutos de sesión bien gestionados. Esto es lo que hacemos en A0Studios con quien graba por primera vez, y lo que puedes preparar tú antes de sentarte delante del objetivo.",
      },
      {
        type: "image",
      ...
      },
      {
        ...
        answer:
          "Ayuda a perder la sorpresa inicial de verte hablando, pero no sustituye la sesión real: en A0Studios cuidamos la luz, el encuadre y la dirección para que ese primer nerviosismo no dependa solo de ti.",
      },
      {
        type: "faq",
  ...
  },
  {
    ...
    description:
      "Cómo convertir una sola sesión de grabación en semanas de contenido para redes sin volver a encender las cámaras. Cómo planteamos el repurposing en A0Studios.",
    ...
    intent: "informacional",
    excerpt:
      "Una sola sesión bien planteada puede dar clips, citas y fragmentos de audio para semanas. Así pensamos el repurposing de vídeo en A0Studios.",
    seoTitle: "Repurposing de vídeo: saca más contenido",
    metaDescription:
      "Repurposing de vídeo: convierte una sola sesión en semanas de contenido para redes sin volver a grabar. Así lo hacemos en A0Studios.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
        text: "En A0Studios grabamos muchas sesiones donde el cliente llega pensando en una sola pieza: un vídeo para LinkedIn, un episodio de podcast, un vídeo de producto. Y se va con eso. Pero de una sesión bien planteada se puede sacar bastante más: clips para redes, citas para carrusel, un fragmento de audio para podcast, hasta ideas para el siguiente guion. A eso lo llamamos repurposing de vídeo.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "faq",
        question: "¿En A0Studios incluís el repurposing dentro de la edición?",
        answer:
  ...
  },
  {
    ...
    description:
      "Un documental de marca no es un vídeo corporativo ni un aftermovie: es una pieza narrativa sobre la historia y las personas de un proyecto. Cómo lo planteamos en A0Studios.",
    ...
    intent: "informacional",
    excerpt:
      "Un documental de marca no es un vídeo corporativo ni un aftermovie: es una pieza narrativa sobre la historia y las personas detrás de un proyecto. Cuándo tiene sentido grabarlo y cómo lo hacemos en A0Studios.",
    seoTitle: "Documental de marca: qué es y cuándo grabarlo",
    metaDescription:
      "Documental de marca: qué es, en qué se diferencia de un aftermovie y cuándo tiene sentido grabarlo en A0Studios.",
    heroKicker: "Blog / A0Studios",
    body: [
      {
        type: "paragraph",
        text: "En A0Studios nos llega bastante gente pidiendo un 'documental de marca' cuando en realidad quiere un aftermovie, un vídeo corporativo o un sizzle reel. No es un problema de vocabulario: son piezas distintas, con objetivos distintos y con un proceso de grabación que no se parece en nada. Un documental de marca es la más exigente de las tres, y también la que mejor envejece.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "faq",
        question: "¿A0Studios produce documentales de marca completos?",
        answer:
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "paragraph",
        text: "Aclara si vas a salir solo con los brutos del día o si también hay edición y entrega en un plazo concreto. En A0Studios, por ejemplo, puedes reservar Solo Grabación, Grabación + Edición o Producción Completa según lo que necesites ese mes concreto. No es lo mismo grabar para archivar que grabar para publicar esa misma semana.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Si vas a grabar contenido de forma recurrente, elegir bien el estudio la primera vez te ahorra meses de intentos fallidos y sesiones repetidas. En A0Studios respondemos hoy y sin compromiso si quieres ver el espacio antes de reservar: escríbenos desde /#contacto.",
      },
    ],
  },
  {
